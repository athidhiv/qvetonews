...
if (loginData.role !== 'admin') throw new Error('Not an admin');
      ...
      <div style={styles.card}>
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            {mode === 'login' ? 'Sign in to access the dashboard' : 'Create a new admin account'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.inputGroup}>
            <input
              ...
              style={styles.input}
            />
            <label style={{...styles.label, top: email ? '-10px' : '16px', fontSize: email ? '12px' : '16px'}}>Admin Email</label>
          </div>
          ...
          {mode === 'create' && (
            <div style={styles.inputGroup}>
              <input
                ...
                style={styles.input}
              />
              <label style={{...styles.label, top: securityKey ? '-10px' : '16px', fontSize: securityKey ? '12px' : '16px'}}>Security Key</label>
            </div>
          )}
          ...
          <button
            ...
            disabled={isLoading}
          >
            {isLoading ? <div style={styles.spinner}></div> : (mode === 'login' ? 'Login' : 'Create Admin')}
          </button>
        </form>
